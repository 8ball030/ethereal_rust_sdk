...
pub struct SubaccountDto {
    ...
    #[serde(rename = "registeredBlockNumber", skip_serializing_if = "Option::is_none")]
...
impl SubaccountDto {
    pub fn new(id: uuid::Uuid, name: String, account: String, created_block_number: String, created_at: f64) -> SubaccountDto {
        SubaccountDto {
            id,
            name,
            account,
