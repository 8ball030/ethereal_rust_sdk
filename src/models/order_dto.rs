...
impl OrderDto {
    pub fn new(id: uuid::Uuid, r#type: Type, available_quantity: String, quantity: String, side: Side, product_id: uuid::Uuid, subaccount_id: uuid::Uuid, status: Status, reduce_only: bool, close: bool, updated_at: f64, created_at: f64, sender: String, price: String, filled: String, stop_price: String, expires_at: f64) -> OrderDto {
        OrderDto {
            id,
