...
impl InitiateWithdrawDtoData {
    pub fn new(account: String, subaccount: String, token: String, amount: String, lz_destination_address: String, lz_destination_eid: LzDestinationEid, nonce: String, signed_at: f64) -> InitiateWithdrawDtoData {
