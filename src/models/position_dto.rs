...
impl PositionDto {
    pub fn new(id: uuid::Uuid, cost: String, size: String, funding_usd: String, funding_accrued_usd: String, fees_accrued_usd: String, realized_pnl: String, total_increase_notional: String, total_increase_quantity: String, total_decrease_notional: String, total_decrease_quantity: String, side: Side, product_id: uuid::Uuid, updated_at: f64, created_at: f64, is_liquidated: bool) -> PositionDto {
        PositionDto {
            id,
            cost,
            size,
