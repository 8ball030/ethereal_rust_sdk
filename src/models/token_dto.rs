...
impl TokenDto {
    pub fn new(id: uuid::Uuid, address: String, lz_oft_address: String, name: String, deposit_enabled: bool, withdraw_enabled: bool, deposit_fee: String, withdraw_fee: String, min_deposit: String, created_at: f64) -> TokenDto {
        TokenDto {
            id,
            address,
            lz_oft_address,
