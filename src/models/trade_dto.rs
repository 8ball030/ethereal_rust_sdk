...
impl TradeDto {
    pub fn new(id: uuid::Uuid, taker_order_id: uuid::Uuid, maker_order_id: uuid::Uuid, maker_fee_usd: String, taker_fee_usd: String, price: String, filled: String, maker_side: MakerSide, taker_side: TakerSide, product_id: uuid::Uuid, created_at: f64) -> TradeDto {
        TradeDto {
            id,
            taker_order_id,
            maker_order_id,
