...
pub struct RefreshLinkedSignerDtoData {
...
impl RefreshLinkedSignerDtoData {
    pub fn new(subaccount_id: uuid::Uuid, sender: String, subaccount: String, signer: String, nonce: String, signed_at: f64) -> RefreshLinkedSignerDtoData {
