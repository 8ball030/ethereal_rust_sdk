...
impl OrderFillDto {
    pub fn new(id: uuid::Uuid, order_id: uuid::Uuid, price: String, filled: String, r#type: Type, side: Side, reduce_only: bool, fee_usd: String, is_maker: bool, product_id: uuid::Uuid, subaccount_id: String, created_at: f64) -> OrderFillDto {
        OrderFillDto {
            id,
            order_id,
