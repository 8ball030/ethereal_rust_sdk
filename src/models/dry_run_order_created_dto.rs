...
impl DryRunOrderCreatedDto {
    pub fn new(margin_required: String, margin_available: String, total_used_margin: String, risk_used: String, risk_available: String, code: Code) -> DryRunOrderCreatedDto {
