...
pub struct PageOfUnrealizedPnlHistoryDtos {
    ...
    /// Array of unrealized PnL history records
    #[serde(rename = "data")]
    pub data: Vec<archive_models::UnrealizedPnlHistoryDto>,
}

impl PageOfUnrealizedPnlHistoryDtos {
    pub fn new(
        has_next: bool,
        data: Vec<archive_models::UnrealizedPnlHistoryDto>,
