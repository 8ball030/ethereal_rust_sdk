...
pub struct PageOfPositionFundingHistoryDtos {
    ...
    /// Array of funding history records
    #[serde(rename = "data")]
    pub data: Vec<archive_models::PositionFundingHistoryDto>,
}

impl PageOfPositionFundingHistoryDtos {
    pub fn new(
        has_next: bool,
        data: Vec<archive_models::PositionFundingHistoryDto>,
