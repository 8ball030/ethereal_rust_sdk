...
pub struct PageOfProductVolumeHistoryDtos {
    ...
    /// Array of product volume history records
    #[serde(rename = "data")]
    pub data: Vec<archive_models::ProductVolumeHistoryDto>,
}

impl PageOfProductVolumeHistoryDtos {
    pub fn new(
        has_next: bool,
        data: Vec<archive_models::ProductVolumeHistoryDto>,
