...
pub struct PageOfProductOpenInterestHistoryDtos {
    ...
    /// Array of product open interest history records
    #[serde(rename = "data")]
    pub data: Vec<archive_models::ProductOpenInterestHistoryDto>,
}

impl PageOfProductOpenInterestHistoryDtos {
    pub fn new(
        has_next: bool,
        data: Vec<archive_models::ProductOpenInterestHistoryDto>,
