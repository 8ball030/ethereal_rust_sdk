...
pub fn referral_controller_activate(configuration: &configuration::Configuration, params: ReferralControllerActivateParams) -> Result<models::ReferralDto, Error<ReferralControllerActivateError>> {
...
pub fn referral_controller_claim_code(configuration: &configuration::Configuration, params: ReferralControllerClaimCodeParams) -> Result<models::ReferralDto, Error<ReferralControllerClaimCodeError>> {
...
pub fn referral_controller_get_code_usage(configuration: &configuration::Configuration, params: ReferralControllerGetCodeUsageParams) -> Result<models::ReferralCodeUsageDto, Error<ReferralControllerGetCodeUsageError>> {

    let uri_str = format!("{}/v1/referral/code/{code}", configuration.base_path, code=crate::apis::urlencode(params.code));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text()?;
        let entity: Option<ReferralControllerGetCodeUsageError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

pub fn referral_controller_get_summary(configuration: &configuration::Configuration, params: ReferralControllerGetSummaryParams) -> Result<models::ReferralDto, Error<ReferralControllerGetSummaryError>> {
    ...
    req_builder = req_builder.header("X-Ethereal-Signature", params.x_ethereal_signature.to_string());
    req_builder = req_builder.header("X-Ethereal-Intent", params.x_ethereal_intent.to_string());
    req_builder = req_builder.header("X-Ethereal-SignedAt", params.x_ethereal_signed_at.to_string());
...
pub fn referral_controller_list_referrals(configuration: &configuration::Configuration, params: ReferralControllerListReferralsParams) -> Result<models::PageOfReferralDtos, Error<ReferralControllerListReferralsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text()?;
        let entity: Option<ReferralControllerListReferralsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}